...
data_root = '/whut_data/datasets/nuscenes/'
...
data = dict(
    ...
    train=dict(
        ...
        use_valid_flag=True,
        box_type_3d='LiDAR'),
    val=dict(type=dataset_type, data_root = data_root, pipeline=test_pipeline, collect_keys=collect_keys +
    ...
    test=dict(type=dataset_type, data_root = data_root, pipeline=test_pipeline, collect_keys=collect_keys +
                                                                      ['img', 'img_metas'], queue_length=queue_length,
              ann_file=data_root + 'nuscenes2d_temporal_infos_val.pkl', classes=class_names, modality=input_modality),
